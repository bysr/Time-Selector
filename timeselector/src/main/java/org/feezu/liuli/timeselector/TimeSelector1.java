...
public class TimeSelector1 {
     ...
     * @return
     */
    public TimeSelector1 startData(String startDate) {
     ...
     * @return
     */
    public TimeSelector1 endData(String endDate) {
     ...
     * @param showTime
     */
    public TimeSelector1 showTime(String showTime) {
...
//    }
    ...
    private void initView() {
        ...
        if (startData == null) startData = "2000-01-01 00:00:00";
        if (endData == null) endData = DateUtil.getNowString(FORMAT_STR);
        if (showData == null) showData = endData;
...
//        year_pv.setSelected(selectedYear + "");
//        month_pv.setSelected(selectedMonth + "");
...
//        second_pv.setSelected(selectedSecond + "");
    ...
    public TimeSelector1 setIsLoop(boolean isLoop) {
